...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14/04/2026 às 13:23
...
CREATE TABLE `usuario` (
  ...
  `perfil` enum('admin','vendedor','cliente') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `venda`
  ...
  ADD CONSTRAINT `fk_venda_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`cpf`) ON UPDATE CASCADE;
