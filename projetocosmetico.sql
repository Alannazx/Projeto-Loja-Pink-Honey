...
--
-- Host: 127.0.0.1
-- Tempo de geração: 12/06/2026 às 13:49
...
INSERT INTO `produto` (`id`, `categoria_id`, `nome`, `marca`, `descricao`, `ativo`) VALUES
(4, 1, 'Base Dior Backstage', 'Dior', 'Base: tom claro', 1),
(5, 1, 'Base Dior Backstage', 'Dior', 'Base: tom médio', 1),
(6, 1, 'Contorno stick', 'Sheglam', 'Contorno: tom coffee', 1),
(7, 1, 'Corretivo líquido', 'Nars', 'Corretivo: tom claro/iluminador', 1),
(8, 1, 'Pó Solto', 'Mari Maria Makeup', 'Pó Solto: tons variados', 1),
(9, 1, 'Blush em pó', 'Dior', 'Blush: tom Rosy Glow', 1),
(10, 1, 'Bruma Real Fix', 'Vizzela', 'Bruma fixadora de maquiagem', 1),
(11, 2, 'Paleta de Maquiagem Nina Secrets', 'Eudora', 'Paleta de Maquiagem Tons Terrosos', 1),
(12, 2, 'Rímel Sky High', 'Maybelline', 'Rímel: tom preto | Super volume', 1),
(13, 2, 'Delineador líquido Make Forever', 'Eudora', 'Delineador: tom preto', 1),
(14, 2, 'Lápis de olho Lasting Precision', 'Kiko Milano', 'Lápis de olho: tom preto', 1),
(15, 2, 'Cílios Postiços Dream Lashes', 'r.e.m. beauty', 'Cílios Postiços', 1),
(16, 2, 'Gel de Sobrancelhas Brow Rise', 'Ruby Rose', 'Gel de Sobrancelhas', 1),
(17, 3, 'Gloss Lip Honey', 'Franciny Ehlke', 'Gloss: aroma de mel', 1),
(18, 3, 'Batom Matte Ruby Woo', 'MAC', 'Batom Matte: tom vermelho (Ruby Woo)', 1),
(19, 3, 'Batom líquido Soft Pinch Tinted', 'Rare Beauty', 'Batom líquido: tom Peach', 1),
(20, 3, 'Gloss Hydra Lipgloss 3D', 'Kiko Milano', 'Gloss: tom 01 transparente', 1),
(21, 3, 'Peptide Lip Tint', 'Rhode', 'Gloss: tons variados', 1),
(22, 3, 'Kylie Jenner Lip Kit', 'Kylie Cosmetics', 'Combo Batom líquido matte + lápis labial | tom: One Wish', 1),
(23, 4, 'Sérum Creamy Ácido Mandélico', 'Creamy Skin Care', 'Sérum Creamy Ácido Mandélico 30g', 1),
(24, 4, 'Gel de Limpeza Facial', 'La Roche Posay', 'Gel de Limpeza Facial', 1),
(25, 4, 'Hidratante Facial Protini Polypeptide', 'Drunk Elephant', 'Hidratante Facial', 1),
(26, 4, 'Kit 2 Lenços Demaquilantes', 'Dermachen', 'Kit 2 Lenços Demaquilantes', 1),
(27, 4, 'Máscara Facial Colágeno Salmon Gel', 'Medicube', 'Máscara Facial Colágeno Salmon Gel', 1),
(28, 4, 'Tônico Watermelon Glow', 'Glow Recipe', 'Tônico facial | aroma: melancia', 1),
(29, 4, 'Cooling Water Bastão Facial Anti Inchaço', 'Milk Makeup', 'Bastão Facial Anti Inchaço', 1),
(30, 5, 'Esponja de Maquiagem', 'Océane', 'Esponja de Maquiagem', 1),
(31, 5, 'Curvex de Cílios', 'Pink 21', 'Curvex para cílios', 1),
(32, 5, 'Espelho de Maquiagem Nina Secrets', 'Eudora', 'Espelho de maquiagem e de mesa Nina Secrets', 1),
(33, 5, 'Kit Pincéis RT', 'Real Techniques', 'Kit Pincéis de maquiagem | 4 unidades', 1),
(34, 5, 'Porta Pincéis Giratório', 'Sephora', 'Porta Pincéis Giratório', 1),
(35, 5, 'Tiara de Cabelo', 'Pink 21', 'Tiara de Skin Care | tons variados', 1),
(36, 5, 'Pincel Triangular de Maquiagem', 'Mari Maria Makeup', 'Pincel Triangular de Maquiagem', 1);
...
(2, 'Leticia', 'leticiatxms@gmail.com', '$2y$10$oCTChs/XIMt1dd4Gq0x/0uE6J6fVWdD/pJb/DCmqmyxTvTpL5Tynm', 'vendedor', 1),
(5, 'Thayssa', 'thyssaofc465@gmail.com', '$2y$10$NaeNZw/47CxEoszN9D0fWeH5x6Cz7tuVQhdp.M4bgFDLAmdZNf6Bi', 'vendedor', 1);
